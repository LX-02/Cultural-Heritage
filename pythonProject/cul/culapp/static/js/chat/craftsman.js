...
const admirersOne = new Map();
const admirersTwo = new Map();
const admirersThree = new Map();
const admirersFour = new Map();
const admirersFive = new Map();
const admirersSix = new Map();
admirersOne.set('002', false);
admirersTwo.set('005', false);
admirersThree.set('001', false);
admirersFour.set('007', false);
admirersFive.set('006', false);
admirersSix.set('005', false);
var commentList = [
    {
        id:getRandomId(),
        commentator:'002',
    ...
    },
    {
        ...
        author:'anonymous',
        comment:'非遗好啊\n',
        time: '2024/1/25 15:38:25',
        thumbUp: 0,
        admirers: null,
        admirers: admirersTwo,
        reply: []
    },
    {
        id:getRandomId(),
        ...
        author:'anonymous',
        comment:'乐亭泥人\n',
        time: '2024/1/24 08:42:11',
        thumbUp: 0,
        admirers: null,
        admirers: admirersThree,
        reply: []
    },
    {
        id:getRandomId(),
...
//         domById('login').innerText = commentator;
//     }
//     initTreeComment();
// }
...
function submitTree (ev) {
    ...
    // const commentator = domById('role_info_name').innerText;    //获取用户名
    const commentator = domById('login').innerText;
    console.log('text.length:', text.length)
    console.log('commentator:', commentator)

    // 或评论内容为空或未登录，则不能评论
    if (text.length === 0 || commentator === '登录') {     
        alarmIfEmpSpace();
        return;
    }
